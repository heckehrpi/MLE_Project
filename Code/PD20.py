# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 20:29:41 2024

@author: henhe
v 0.20 redoing fit centroids code from v0.16 to actually work with code from v0.19
...
class PlotDigitizer:
    ...
    def _classify_cluster_features(self, isolated_clusters, background_tol=0.25, axis_tol = 0.5,):
    ...
    def _detect_plot_bounds(self, isolated_clusters, layer_attributes, background_tol=0.25, plot_background_tol=0.45, axis_tol = 0.5, buffer=10):
