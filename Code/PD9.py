# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 15:02:53 2024
...
class PlotDigitizer:
    ...
    def __init__(self, fig_name, xlim, ylim, num_plots, verbose = False, debug=False):
        ...
        self.kmeans = KMeans(self._n_clusters, n_init=1, init='k-means++')
        print("fitting image...")
    ...
    def _fit_centroids(self, epochs=50, init_split=0.15, radius_factor=0.0075, denoise_tol=2, debug_plot=False):
