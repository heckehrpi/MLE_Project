# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 12:37:21 2024
...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 10:53:21 2024
...
class PlotDigitizer:
    ...
    def fit_centroids(self, max_iter=50, debug_plot=False, test_split=0.25, n_radius=10, radius_ratio=200):
        ...
        while num_iter <= max_iter:
            ...
            if np.array_equal(self.centroids, centroids_fit):
                print("centroid array actually unchanging")
                break
